<div class="w-full" x-data="window.yUOVkgHfZIoHQDO">
        ...
        <div class="col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3">
            <div class="shadow-sm rounded-md p-4 bg-white">
                <div class="flex items-center">
                    <span class="rounded-sm relative p-4 bg-indigo-100">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 text-primary-600 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                        </svg>
                    </span>
                    <div class="ml-2 rtl:mr-2 rtl:!ml-0">
                        <div class="text-sm tracking-wide font-bold mb-0.5 block">
                            {{ __('messages.t_net_income') }}
                        </div>
                        <div class="text-xs font-normal text-gray-500 h-6">
                            {{ __('messages.t_total_income_from_orders_including_pending') }}</div>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
                    <p
                        class="text-gray-700 dark:text-gray-100 text-2xl ltr:text-left rtl:text-right font-black  tracking-wide mt-4">
            ...
            <div class="shadow-sm rounded-md p-4 bg-white">
                <div class="flex items-center">
                    ...
                    <div class="ml-2 rtl:mr-2 rtl:!ml-0">
                        ...
                        <div class="text-xs font-normal text-gray-500 h-6">{{ __('messages.t_income_from_taxes') }}
                        </div>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
            ...
            <div class="shadow-sm rounded-md p-4 bg-white">
                <div class="flex items-center">
                    ...
                    <div class="ml-2 rtl:mr-2 rtl:!ml-0">
                        ...
                        <div class="text-xs font-normal text-gray-500 h-6">{{ __('messages.t_income_from_commission') }}
                        </div>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
            ...
            <div class="shadow-sm rounded-md p-4 bg-white">
                <div class="flex items-center">
                    ...
                    <div class="ml-2 rtl:mr-2 rtl:!ml-0">
                        ...
                        <div class="text-xs font-normal text-gray-500 h-6">
                            {{ __('messages.t_approved_withdrawn_money_by_users') }}</div>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
                    <p
            ...
            <div class="shadow-sm rounded-md p-4 bg-white">
                <div class="flex items-center">
                    ...
                    <div class="ml-2 rtl:mr-2 rtl:!ml-0">
                        ...
                        <div class="text-xs font-normal text-gray-500 h-6">{{ __('messages.t_total_success_sales') }}
                        </div>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
            ...
            <div class="shadow-sm rounded-md p-4 bg-white">
                <div class="flex items-center">
                    ...
                    <div class="ml-2 rtl:mr-2 rtl:!ml-0">
                        ...
                        <div class="text-xs font-normal text-gray-500 h-6">
                            {{ __('messages.t_total_gigs_including_pending') }}</div>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
                    <p
            ...
            <div class="shadow-sm rounded-md p-4 bg-white">
                <div class="flex items-center">
                    ...
                    <div class="ml-2 rtl:mr-2 rtl:!ml-0">
                        ...
                        <div class="text-xs font-normal text-gray-500 h-6">
                            {{ __('messages.t_total_users_including_pending') }}</div>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
                    <p
            ...
            <div class="shadow-sm rounded-md p-4 bg-white">
                <div class="flex items-center">
                    ...
                    <div class="ml-2 rtl:mr-2 rtl:!ml-0">
                        ...
                        <div class="text-xs font-normal text-gray-500 h-6">
                            {{ __('messages.t_total_messages_between_users') }}</div>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
                    <p
    ...
    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6 mb-8">
        ...
        {{-- Left side --}}
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-4">
                ...
                <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                    <div class="bg-slate-50 px-6 py-4 rounded-md">
                        <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-bold tracking-widest text-gray-800">{{ __('messages.t_latest_users') }}</h3>
                    ...
                    <div class="intro-x">
                        <div class="bg-white shadow-sm rounded-lg px-5 py-3 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="{{ $user->username }}" src="{{ src($user->avatar) }}">
                            </div>
                            <div class="ltr:ml-4 ltr:mr-auto rtl:mr-4 rtl:ml-auto">
                                ...
                                <div class="text-slate-500 text-xs mt-0.5 text-[11px]">{{ format_date($user->created_at, 'F j Y h:m') }}</div>
                            </div>
                        </div>
                    </div>
                @empty
        ...
        {{-- Right side --}}
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-8">
            ...
            <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
                ...
                <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ml-4 mt-4">
                            <h3 class="text-base leading-6 font-bold tracking-widest text-gray-800">
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-6">
            <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
                ...
                <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ml-4 mt-4">
                            <h3 class="text-base leading-6 font-bold tracking-widest text-gray-800">{{ __('messages.t_os') }}</h3>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-6">
            <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
                ...
                <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ml-4 mt-4">
                            <h3 class="text-base leading-6 font-bold tracking-widest text-gray-800">{{ __('messages.t_devices') }}</h3>
        ...
        <div class="col-span-12">
            <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
                ...
                <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ml-4 mt-4">
                            <h3 class="text-base leading-6 font-bold tracking-widest text-gray-800">{{ __('messages.t_browsers') }}</h3>
