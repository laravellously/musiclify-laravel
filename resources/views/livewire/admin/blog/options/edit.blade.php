<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            {{-- Section header --}}
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900">{{ __('messages.t_edit_article') }}</h2>
            </div>
            ...
            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                ...
                {{-- Image --}}
                <div class="col-span-12">
                    <x-forms.file-input :label="__('messages.t_article_image')" model="image" accept="image/jpg,image/jpeg,image/png,image/svg+xml"  />
                    {{-- Preview image --}}
                    @if ($article->image)
                        <div class="mt-3">
                            <img src="{{ src( $article->image ) }}" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
