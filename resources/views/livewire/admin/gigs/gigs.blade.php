                    ...
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="reports-{{ $gig->id }}">
                        ...
                        <td class="ltr:pl-4 ltr:pr-10 rtl:pr-4 rtl:pl-10 w-[40%]">
                            <div class="flex items-center">
                                <div class="w-8 h-8">
                                    <img class="w-full h-full rounded object-cover" src="{{ src($gig->thumbnail) }}" alt="{{ $gig->title }}" />
                                </div>
                                <div class="ltr:pl-4 rtl:pr-4">
                                    <a href="{{ url('service', $gig->slug) }}" target="_blank" class="font-medium text-xs hover:text-primary-600 truncate pb-1.5 block max-w-xs">{{ $gig->title }}</a>
                        ...
                        {{-- Rating --}}
                        <td class="text-center">
                            <div class="gig-card-rating-container mx-auto mb-1 z-0" data-rating-value="{{ $gig->rating }}"></div>
