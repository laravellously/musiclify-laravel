                ...
                <div class="col-span-12">
                    <div class="relative">
                        ...
                        <input type="text" placeholder="{{ __('messages.t_youtube_placeholder') }}"
                            ...
                            class="block w-full text-xs rounded border-2 pr-10 py-3 pl-3 font-normal {{ $errors->first('video_link') ? 'border-red-500 text-red-600 placeholder-red-400 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 placeholder-gray-400 focus:ring-primary-600 focus:border-primary-600' }}">

                        {{-- Icon --}}
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            <i
                                class="mdi mdi-youtube {{ $errors->first('video_link') ? 'text-red-400' : 'text-gray-400' }}"></i>
                        </div>
