                    ...
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="subcategories-{{ $c->id }}">
                        ...
                        <td class="ltr:pl-4 rtl:pr-4">
                            <a href="{{ url('categories/' . $c->parent->slug . "/" . $c->slug) }}" target="_blank" class="flex items-center">
                                <div class="w-8 h-8">
                                    <img class="w-full h-full rounded object-cover" src="{{ src($c->icon) }}" alt="{{ $c->name }}" />
                                </div>
                                <div class="ltr:pl-4 rtl:pr-4">
                                    <p class="font-medium text-xs">{{ $c->name }}</p>
                                    <p class="text-[11px] leading-3 text-gray-600 pt-2">{{ $c->description }}</p>
                                </div>
                            </a>
                        </td>
                        ...
                        <td class="ltr:pl-4 rtl:pr-4">
                            <a href="{{ url('categories', $c->parent->slug) }}" target="_blank" class="flex items-center">
                                <div class="w-8 h-8">
                                    <img class="w-full h-full rounded object-cover" src="{{ src($c->parent->icon) }}" alt="{{ $c->parent->name }}" />
                                </div>
                                <div class="ltr:pl-4 rtl:pr-4">
                                    <p class="font-medium text-xs">{{ $c->parent->name }}</p>
                                    <p class="text-[11px] leading-3 text-gray-600 pt-2">{{ $c->parent->description }}</p>
                                </div>
                            </a>
                        </td>
                        ...
                        <td class="text-center">
                            <img class="w-8 h-8 rounded object-cover mx-auto" src="{{ src($c->image) }}" alt="{{ $c->name }}" />
                        </td>
