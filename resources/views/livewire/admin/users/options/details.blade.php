                                ...
                                <dd class="mt-1 text-[13px] font-medium text-gray-900">
                                    @if ($user->country)
                                        <div class="flex items-center">
                                            <img src="{{ url('public/img/flags/' . strtolower($user->country->code) . '.svg') }}"
        ...
        <section class="lg:col-start-3 lg:col-span-1">
            <div class="flex flex-col text-center bg-white rounded-lg shadow divide-y divide-gray-200">
                <div class="flex-1 flex flex-col p-8">
                    <img class="w-32 h-32 flex-shrink-0 mx-auto rounded-full object-cover" src="{{ src($user->avatar) }}" alt="{{ $user->username }}">
