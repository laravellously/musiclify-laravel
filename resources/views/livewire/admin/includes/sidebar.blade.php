<div>
    ...
    {{-- Desktop sidebar --}}
    <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0 h-full ltr:border-r rtl:border-l border-gray-100">
        <div class="py-4 text-gray-400 dark:text-gray-400">
            <ul class="space-y-3">
                ...
                <li class="relative px-4 flex items-center group !mt-8">
                    <div class="text-xs font-normal text-gray-400">You are running Riverr version {{ config('global.version') }}</div>
                </li>
