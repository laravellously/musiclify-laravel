        ...
        <div class="col-span-12 lg:col-span-8">
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-6 pb-8">
                    ...
                    {{-- Task scheduling --}}
                    <code class="block text-xs text-[#BFC7D5] bg-[#292D3E] px-4 leading-6 py-3 mb-6"><span class="text-amber-500">* * * * *</span> cd <span class="text-white">{{ base_path() }}</span> && <span class="text-white">{{ $pathToPhp }}</span> artisan <span class="text-amber-500">schedule:run</span> >> /dev/null 2>&1</code>

                    {{-- Queue --}}
                    <code class="block text-xs text-[#BFC7D5] bg-[#292D3E] px-4 leading-6 py-3"><span class="text-amber-500">* * * * *</span> cd <span class="text-white">{{ base_path() }}</span> && <span class="text-white">{{ $pathToPhp }}</span> artisan <span class="text-amber-500">queue:work --stop-when-empty</span> >> /dev/null 2>&1</code>
