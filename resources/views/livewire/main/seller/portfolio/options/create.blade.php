        ...
        <header class="bg-gray-50 dark:bg-zinc-700 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 dark:text-gray-100 sm:text-2xl sm:truncate">{{ __('messages.t_create_project') }}</h1>
            ...
            <div class="max-w-xl m-auto px-6 lg:px-0 py-8">
                <div class="grid col-span-12 md:gap-x-6 gap-y-6">
                    ...
                    <div class="col-span-12 mt-6">
                        <x-forms.button :text="__('messages.t_create_project')" action="create" :block="true" />
                    </div>
