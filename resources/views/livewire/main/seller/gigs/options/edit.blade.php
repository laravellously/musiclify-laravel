<div class="container mx-auto">
    ...
    {{-- Section header --}}
    <div class="min-h-full bg-white dark:bg-zinc-800 shadow rounded-md mb-12">
        ...
        <header class="bg-gray-50 dark:bg-zinc-700 py-8 rounded-b-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 dark:text-gray-100 sm:text-2xl sm:truncate">{{ __('messages.t_edit_gig') }}</h1>
