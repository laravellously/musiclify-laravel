                ...
                <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="mt-2 relative">
                            <input type="text" placeholder="0.00" wire:model.defer="amount" id="text-input-component-id-amount" class="dark:bg-transparent block w-full text-xs rounded border-2 pr-10 py-3 pl-3 font-normal {{ $errors->first('amount') ? 'border-red-500 text-red-600 placeholder-red-400 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 placeholder-gray-400 focus:ring-primary-600 focus:border-primary-600 dark:border-zinc-700 dark:text-gray-200' }}">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <i class="mdi mdi-cash-multiple {{ $errors->first('amount') ? 'text-red-400' : 'text-gray-400' }}"></i>
                            </div>
                        </div>
