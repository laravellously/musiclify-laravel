...
class Sidebar extends Component
{
    ...
    public function mount()
    {
        ...
        $this->links = [
            ...
            //         [ 'text' => __('messages.t_projects_settings'), 'href' => "$dashboard/projects/settings" ],
            //     ],
            // ],
            ...
            [
                ...
                'childs' => [
                    ...
                    [ 'text' => __('messages.t_sliders'), 'href' => "$dashboard/settings/sliders" ],
            ...
            // Logs
            [
                'icon'   => '<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor"> <path fill-rule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm3.293 1.293a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414L7.586 10 5.293 7.707a1 1 0 010-1.414zM11 12a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"/></svg>',
                'text'   => __('messages.t_system_logs'),
                'href'   => $dashboard . "/logs",
                'childs' => null
            ],
            ...
            [
                ...
                'text'   => __('messages.t_cron_jobs'),
                'href'   => $dashboard . "/crontab",
                'childs' => null
            ],
