...
class Overview extends Component
{
    ...
    {
        // Seo
        $this->seo()->setTitle( setSeoTitle(__('messages.t_edit_overview'), true) );
        $this->seo()->setDescription( settings('seo')->description );

        return view('livewire.admin.gigs.options.steps.overview', [
    ...
    public function save()
    {
        try {
            ...
            // Success
            return redirect( config('global.dashboard_prefix') . "/gigs/edit/" . $this->gig->uid . "?step=pricing" )->with('success', __('messages.t_overview_section_has_been_saved'));
