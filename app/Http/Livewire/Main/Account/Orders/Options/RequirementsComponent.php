        ...
        try {
            ...
            if ($this->item->is_requirements_sent && $this->item->requirements()->count()) {
                ...
                $this->dispatchBrowserEvent('alert',[
                    "message" => __('messages.t_user_already_submitted_requirements'),
                    "type"    => "error"
                ]);
            ...
            if (count($this->requirements)) {
                ...
                $this->dispatchBrowserEvent('alert',[
                    "message" => __('messages.t_required_info_submitted_success')
                ]);
            ...
            switch ($e->getMessage()) {
                ...
                case 'REQUIRED_INPUT_NOT_EXISTS_IN_REQUEST':
                    ...
                    // Show error
                    $this->dispatchBrowserEvent('alert',[
                        "message" => __('messages.t_exception_REQUIRED_INPUT_NOT_EXISTS_IN_REQUEST'),
                        "type"    => "error"
                    ]);
                ...
                case 'REQUIRED_INPUT_TEXT_LENGTH_VALIDATION_FAILED':
                    ...
                    // Show error
                    $this->dispatchBrowserEvent('alert',[
                        "message" => __('messages.t_exception_REQUIRED_INPUT_TEXT_LENGTH_VALIDATION_FAILED'),
                        "type"    => "error"
                    ]);
                ...
                case 'REQUIRED_CHOICE_MULTIPLE_VALUES_NOT_EXISTS':
                    ...
                    // Show error
                    $this->dispatchBrowserEvent('alert',[
                        "message" => __('messages.t_exception_REQUIRED_CHOICE_MULTIPLE_VALUES_NOT_EXISTS'),
                        "type"    => "error"
                    ]);
                ...
                case 'REQUIRED_CHOICE_VALUE_NOT_EXISTS':
                    ...
                    // Show error
                    $this->dispatchBrowserEvent('alert',[
                        "message" => __('messages.t_exception_REQUIRED_CHOICE_VALUE_NOT_EXISTS'),
                        "type"    => "error"
                    ]);
                ...
                case 'REQUIRED_FILE_VALIDATION_FAILED':
                    ...
                    // Show error
                    $this->dispatchBrowserEvent('alert',[
                        "message" => __('messages.t_exception_REQUIRED_FILE_VALIDATION_FAILED'),
                        "type"    => "error"
                    ]);
